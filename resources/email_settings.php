...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $posted = [
        ...
        'bcc_enabled' => isset($_POST['bcc_enabled']) ? 1 : 0,
        'bcc_email' => trim($_POST['bcc_email'] ?? ''),
        'notify_on_create' => isset($_POST['notify_on_create']) ? 1 : 0,
        'notify_on_status_update' => isset($_POST['notify_on_status_update']) ? 1 : 0,
    ];
                ...
                <form class="admin-card mb-4" action="" method="post">
                    ...
                    <div class="admin-card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-8">
                                ...
                                <input type="text" name="smtp_host" id="smtp_host" class="form-control"
                                    placeholder="smtp.example.com" value="<?= htmlspecialchars($saved['smtp_host']) ?>">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="bcc_enabled" value="1"
                                        id="bcc_enabled" <?= $saved['bcc_enabled'] ? 'checked' : '' ?>>
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="notify_on_create" value="1"
                                id="notify_on_create" <?= $saved['notify_on_create'] ? 'checked' : '' ?>>
...
function copySmtpFieldsIntoTestForm(testForm) {
    ...
    document.getElementById('test_bcc_enabled').value = (bccSource && bccSource.checked) ? '1' : '';
    return true;
}
</script>
HTML;
