		...
		<div class="container">
			<div class="row">
				<div class="services-wrap row" style="text-align: left;">
					<div class="item col-md-4 wow fadeInUp" data-wow-delay="0.3s">
						<div class="services-content">
							<div class="services-thumb">
								<a href="#">
									<img src="themes/theme1/images/services/service1.jpg" alt="images" width="371px">
					...
					<div class="item col-md-4 wow fadeInUp" data-wow-delay="0.6s">
						<div class="services-content">
							<div class="services-thumb">
								<a href="#">
									<img src="themes/theme1/images/services/service2.jpg" alt="images" width="371px">
									<div class="overlay"></div>
								</a>
							</div>
							<div class="services-text">
								...
								<p>
									...
									Full container loads or less than container LCL shipments, port to port or door to
									door.
								</p>
					...
					<div class="item col-md-4 wow fadeInUp" data-wow-delay="0.9s">
						<div class="services-content">
							<div class="services-thumb">
								<a href="#">
									<img src="themes/theme1/images/services/service3.jpg" alt="images" width="371px">
									<div class="overlay"></div>
								</a>
							</div>
							<div class="services-text">
				...
				<div class="services-wrap row" style="text-align: left;">
						...
						<div class="services-content">
							<div class="services-thumb">
								<a href="diplomatic-bag-and-secure-logistics">
									<img src="themes/theme1/images/services/service4.jpg" alt="images" width="371px">
									<div class="overlay"></div>
								</a>
							</div>
							<div class="services-text">
					...
					<div class="item col-md-4 wow fadeInUp" data-wow-delay="0.6s">
						<div class="services-content">
							<div class="services-thumb">
								<a href="#">
									<img src="themes/theme1/images/services/service5.jpg" alt="images" width="371px">
									<div class="overlay"></div>
								</a>
							</div>
							<div class="services-text">
					...
					<div class="item col-md-4 wow fadeInUp" data-wow-delay="0.9s">
						<div class="services-content">
							<div class="services-thumb">
								<a href="#">
									<img src="themes/theme1/images/services/service6.jpg" alt="images" width="371px">
									<div class="overlay"></div>
								</a>
							</div>
							<div class="services-text">
				...
				<div class="row wow fadeIn" data-wow-delay="0.5s">
					<div class="col-md-4">
						<img src="themes/theme1/images/services/service-right-1.jpg" alt="">
					</div>
					<div class="col-md-8">
