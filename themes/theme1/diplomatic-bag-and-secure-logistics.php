			...
			<div class="title-wrap wow fadeIn" data-wow-delay="1s">
				...
				<div class="breadcrumbs">
					<p>You Are Here :
						...
						<span class="arrow"><i class="icon icon-arrow-right"></i></span>
						<span>Diplomatic Bag and Secure Logistics</span>
					</p>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="row wow fadeIn" data-wow-delay="0.5s">
					<div class="col-md-4">
						<img src="themes/theme1/images/diplomatic-bag-compressor.jpg" alt="">
					</div>
					<div class="col-md-8">
						...
						<p style="text-align: justify;">
							...
							Our diplomatic courier services, known as the <?php echo $row['name']; ?> Messengers, make
							sure sensitive material is always kept safe throughout its
							entire journey.
						</p>
						<p style="text-align: justify;">
