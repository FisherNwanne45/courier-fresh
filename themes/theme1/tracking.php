<?php
// This file lives at themes/{theme}/tracking.php -- resources/ is two levels
...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="themes/theme1/tracking_files/bootstrap.min.css"
            integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO"
            crossorigin="anonymous" />
        <script src="themes/theme1/tracking_files/jquery.min.js.download"></script>
        <script src="themes/theme1/tracking_files/popper.min.js.download"
            integrity="sha384-ZMP7rVo3mIykV+2+9J3UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49" crossorigin="anonymous">
        </script>
        <script src="themes/theme1/tracking_files/bootstrap.min.js.download"
            integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous">
        </script>
        <link href="themes/theme1/tracking_files/global.css" rel="stylesheet" />
        <link href="themes/theme1/tracking_files/tracking.css" rel="stylesheet" />
        <script defer="" src="themes/theme1/tracking_files/global.js.download"></script>
        <script defer="" src="themes/theme1/tracking_files/tracking.js.download"></script>
    </head>
    ...
    <body>
        <header>
            <style>
                /* Theme1's own look for the shared translator widget (see
                   resources/translator.php) -- Google's real widget,
                   styled in place. Languages themselves are set from admin
                   Appearance settings. */
            ...
            <a href="<?php echo $url; ?>/">
                <div class="companyName ml-3"></div>
            </a>
            <div class="site-translator-wrap ml-3">
        ...
        <script src="themes/theme1/tracking_files/umhcs11zyowawz03ycjpsi4myawb3tqz.js.download" async=""></script>
        <script src="themes/theme1/tracking_files/sweetalert.min.js.download"></script>
    </body>
    <?php echo $row['tawk']; ?>
