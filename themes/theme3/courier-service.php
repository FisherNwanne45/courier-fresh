<?php
$pageTitle = "Courier Service";
$pageDescription = "Fast, reliable courier service.";
...
?>
        ...
        <div class="container d-flex flex-nowrap align-items-center justify-content-between">
            <div class="logo-and-menu-area">
                <a href="index.php" class="header-logo">
                    <img src="resources/img/<?= htmlspecialchars($row['image']) ?>" alt="<?= htmlspecialchars($row['name']) ?>" style="max-height:40px;">
                </a>
                <div class="main-menu">
        ...
        <div class="container">
            <div class="row align-items-center justify-content-between">
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="single-slide">
                                        <p>Reliable courier service for customers around the world.</p>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="single-slide">
                                        <p>Real-time tracking on every shipment, every time.</p>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="single-slide">
                                        <p>Fast &amp; secure delivery, wherever you're shipping.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-4 d-flex align-items-center justify-content-end">
                    <a class="primary-btn2 d-md-flex d-none btn-hover" href="contact.php">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-xl-5 col-lg-6">
                    <div class="banner-content-wrapper">
                        <div class="banner-content">
                            ...
                            <p>Reliable courier delivery for parcels and documents, wherever you need them to go.</p>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-8">
                    <div class="banner-img-area">
                        <img src="themes/theme3/assets/img/home4/home4-banner-img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        <img class="shape" src="themes/theme3/assets/img/home4/vector/banner-shape.png" alt="">
    </div>
    <!-- home4 Banner Section End-->

    <!-- Home4 Contact Info Start -->
    <div class="home2-contact-info three">
        <div class="container">
            <div class="row gy-4 align-items-center justify-content-between">
                <div class="col-xl-5 col-lg-7 col-md-7">
                    <div class="contact-tracking-area">
                        <h5>Tracking Your Percel</h5>
                        ...
                        <p>To face any trouble when tracking percel?
                            <a href="contact.php">Contact Us</a> for quick respons.
                        </p>
                    </div>
                </div>
                    ...
                    <ul class="contact-list">
                        <li class="single-contact">
                            <div class="icon">
                                <svg width="18" height="13" viewBox="0 0 18 13" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path
                                        d="M16.418 0.25H1.58203C1.34578 0.25 1.12356 0.305617 0.922078 0.398816L6.70799 6.20392C6.70837 6.20431 6.70883 6.20438 6.70922 6.20477C6.70946 6.20502 6.70962 6.20534 6.70968 6.20568L8.59099 8.09322C8.79082 8.29305 9.20925 8.29305 9.40908 8.09322L11.29 6.206C11.29 6.206 11.2905 6.20515 11.2909 6.20477C11.2909 6.20477 11.2917 6.20431 11.2921 6.20392L17.0779 0.398781C16.8764 0.305547 16.6542 0.25 16.418 0.25ZM0.168258 1.13636C0.0639844 1.34723 0 1.5813 0 1.83203V11.3242C0 11.575 0.0639141 11.809 0.168223 12.0199L5.59223 6.5783L0.168258 1.13636ZM17.8317 1.13629L12.4078 6.5783L17.8317 12.02C17.936 11.8091 18 11.575 18 11.3242V1.83203C18 1.58123 17.936 1.34716 17.8317 1.13629Z" />
                                </svg>

                            </div>
                            <div class="contact-content">
                                <p>Send Your Document via</p>
                        ...
                        <li class="single-contact">
                            ...
                            <div class="contact-content">
                                ...
                                <a href="tel:99656786534"><?= htmlspecialchars($row['phone']) ?></a>
                            </div>
                        </li>
                    </ul>
                </div>
        ...
        <img class="img-1" src="themes/theme3/assets/img/home4/vector/home4-contact-info-shape1.png" alt="">
        <img class="img-2" src="themes/theme3/assets/img/home4/vector/home4-contact-info-shape2.png" alt="">
    </div>
    <!-- Home4 Contact Info End -->
            ...
            <div class="row justify-content-center wow animate fadeInDown" data-wow-delay="200ms"
                ...
                <div class="col-xxl-6 col-xl-8 col-lg-7">
                    <div class="section-title text-center mb-60">
                        <h2><span>Reliability</span>.Speed & Efficiency.</h2>
                    </div>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-xl-8 col-lg-12 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="feature-card one">
                        <div class="feature-content-wrap">
                            <div class="feature-icon">
                                <img src="themes/theme3/assets/img/home4/icon/feature-icon-img1.svg" alt="">
                            </div>
                            <div class="feature-content">
                                <h3>Real-Time Tracking</h3>
                                <p>Live Tracking – Live location updates from pickup to drop-off.</p>
                            </div>
                        </div>
                        <div class="feature-img-wrap">
                            <img src="themes/theme3/assets/img/home4/feature-img1.png" alt="">
                            <img src="themes/theme3/assets/img/home4/feature-img2.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="feature-card two">
                        <div class="feature-content-wrap">
                            <div class="feature-icon">
                                <img src="themes/theme3/assets/img/home4/icon/feature-icon-img2.svg" alt="">
                            </div>
                            <div class="feature-content">
                                <h3>24/7 Customer Support</h3>
                                <p>Round-the-clock assistance for queries, issues, or tracking help.</p>
                            </div>
                        </div>
                        <img class="vector-img" src="themes/theme3/assets/img/home4/vector/featurea-card-4-vector2.png" alt="">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="feature-card three">
                        <div class="feature-content-wrap">
                            <div class="feature-icon">
                                <img src="themes/theme3/assets/img/home4/icon/feature-icon-img3.svg" alt="">
                            </div>
                            <div class="feature-content">
                                <h3>Customized Solutions</h3>
                                <p>Easy access to delivery status through mobile or web platforms.</p>
                            </div>
                        </div>
                        <img class="vetor-img2" src="themes/theme3/assets/img/home4/vector/featurea-card-4-vector.png" alt="">
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="feature-card four">
                        <div class="feature-content-wrap">
                            <div class="feature-icon">
                                <img src="themes/theme3/assets/img/home4/icon/feature-icon-img4.svg" alt="">
                            </div>
                            <div class="feature-content">
                                <h3>100% Safe Delivery</h3>
                                <p>Secure Packaging – Protection for fragile and valuable items.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="feature-card five">
                        <div class="feature-content-wrap">
                            <div class="feature-icon">
                                <img src="themes/theme3/assets/img/home4/icon/feature-icon-img5.svg" alt="">
                            </div>
                            <div class="feature-content">
                                <h3>Door-to-Door Service</h3>
                                <p>Door-to-Door Service – Convenient collection and delivery at your location.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12 d-flex align-items-center justify-content-center">
                    <div class="tracking-btn mt-60">
                        <p>Do you want to connecting the world one mile at a time!</p>
                        <a class="track-btn" href="contact.php">
                            Request a Quote
                            <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="calculate-shipping-area mb-120 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-10">
                    <div class="calculate-shipping-area-wrapper">
                        <div class="section-title text-center">
                            <h2><span>Calculate </span>Shipping Rate</h2>
                        </div>
                        ...
                        <form id="shipCalcForm" onsubmit="return false;">
                            <div class="check-area">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="calcZone"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="calcZone"
                                        id="flexRadioDefault2" value="2.4">
                            ...
                            <div class="row g-4 mb-50">
                                <div class="col-md-4">
                                    <div class="form-inner">
                                        <label>From <span>(Your Location)</span></label>
                                        <input type="text" id="calcFrom" placeholder="Sydney, Australia">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-inner">
                                        <label>To <span>(Another Location)</span></label>
                                        <input type="text" id="calcTo" placeholder="Melbourne, Australia">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-inner">
                                        <label>Weight <span>(Kilogram)</span></label>
                                        <select id="calcWeight">
                                ...
                                <div class="col-md-6">
                                    <div class="form-inner">
                                        ...
                                        <input type="number" id="calcUnits" min="1" step="1" value="1" placeholder="1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-inner">
                                        ...
                                        <select id="calcType">
                                            <option value="5.2">Air Freight</option>
                                            <option value="0.9">Ocean Freight</option>
                                            <option value="2.1">Road Freight</option>
                                            <option value="1.8">Rail Freight</option>
                                            <option value="3.0">Reverse Freight</option>
                                            <option value="6.5">Door-to-Door Freight</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="btn-and-contact-area">
                            <button class="primary-btn2 black-bg btn-hover" type="button" id="calcButton">
                                Cost Calculation
                                <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                    <g>
                                        <path
                        ...
                        <div id="calcResult" style="display:none; margin-top:20px; padding:16px 20px; border-radius:10px; background:#f4f5ff;">
                            <strong style="font-size:20px;">Estimated cost: <span id="calcResultValue">$0.00</span></strong>
                            <p style="margin:6px 0 0; font-size:13px; color:#666;">This is an estimate only -- final pricing is confirmed by our team.</p>
                        </div>
                        <p>N:B- <span>VATS(1.5%)</span> are included in country-wise & internationally.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xxl-9 col-lg-10">
                    <div class="section-title text-center mb-120">
                        <h2>We are committed to providing
                            exceptional courier and logistics solutions designed to meet the diverse needs of businesses
                            &
                            individuals.</h2>
                    </div>
                </div>
            ...
            <div class="swiper home4-service-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="service-card2">
                            <div class="service-card-img">
                                <img src="themes/theme3/assets/img/home4/service-img1.png" alt="">
                            </div>
                            <div class="service-content">
                                ...
                                <p>Quick and urgent delivery within the same day, pre-arranged pickup and drop-off at
                                    specific times.</p>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="service-card2">
                            <div class="service-card-img">
                                <img src="themes/theme3/assets/img/home4/service-img2.png" alt="">
                            </div>
                            <div class="service-content">
                                <div class="icon">
                                    <svg width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h2>
                                    <a href="services.php">International Shipping</a>
                                </h2>
                                <p>End-to-end delivery solutions for online businesses, including <span>tracking,
                                        returns, and COD (Cash on Delivery).</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="service-card2">
                            <div class="service-card-img">
                                <img src="themes/theme3/assets/img/home4/service-img3.png" alt="">
                            </div>
                            <div class="service-content">
                                <div class="icon">
                                    <svg width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h2>
                                    <a href="services.php">Delivery Solutions</a>
                                </h2>
                                <p>Expert handling of customs duties, documentation, and compliance. Land transport for
                                    heavy or bulk shipments.</p>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="service-card2">
                            <div class="service-card-img">
                                <img src="themes/theme3/assets/img/home4/service-img4.png" alt="">
                            </div>
                            <div class="service-content">
                                <div class="icon">
                                    <svg width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h2>
                                    <a href="services.php">Warehousing Storage</a>
                                </h2>
                                <p>Quick and urgent delivery within the same day, pre-arranged pickup and drop-off at
                                    specific times.</p>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="service-card2">
                            <div class="service-card-img">
                                <img src="themes/theme3/assets/img/home4/service-img5.png" alt="">
                            </div>
                            <div class="service-content">
                                <div class="icon">
                                    <svg width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <h2>
                                    <a href="services.php">Freight Forwarding</a>
                                </h2>
                                <p>Quick and urgent delivery within the same day, pre-arranged pickup and drop-off at
                                    specific times.</p>
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="service-card2">
                            <div class="service-card-img">
                                <img src="themes/theme3/assets/img/home4/service-img6.png" alt="">
                            </div>
                            <div class="service-content">
                                <div class="icon">
                                    <svg width="50" height="50" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M47.6562 10.9376H9.375C8.08281 10.9376 7.03125 11.9891 7.03125 13.2813V15.618L1.34844 9.61959C1.24065 9.50692 1.10167 9.42901 0.949317 9.39585C0.796963 9.36268 0.638175 9.37576 0.493306 9.43343C0.348438 9.49109 0.224089 9.5907 0.1362 9.71949C0.04831 9.84828 0.000883772 10.0004 0 10.1563L0 26.5626C1.75691e-05 26.6783 0.0257492 26.7926 0.0753349 26.8972C0.124921 27.0017 0.197121 27.094 0.286719 27.1672L7.03125 32.6844V41.4063C7.03125 42.6985 8.08281 43.7501 9.375 43.7501H12.1766L13.8305 45.404C14.275 45.8493 14.8648 46.0938 15.4922 46.0938H27.3438C27.4132 46.0939 27.4823 46.0847 27.5492 46.0665C27.6602 46.0844 27.775 46.0938 27.8906 46.0938H29.625C30.4922 46.0938 31.2367 45.5969 31.
.1518 30.311 33.7274 30.3125 33.2969C30.3125 32.6126 30.0617 31.9555 29.6078 31.4493L25.5391 26.8727C24.9462 26.2047 24.1425 25.7597 23.2617 25.6118L15.2312 24.2719L8.59375 17.2672V13.2813C8.59375 12.8508 8.94375 12.5001 9.375 12.5001H20.3125V19.5313C20.3126 19.6726 20.351 19.8113 20.4236 19.9325C20.4963 20.0537 20.6004 20.153 20.725 20.2197C20.8496 20.2864 20.9899 20.318 21.1311 20.3113C21.2722 20.3045 21.4089 20.2596 21.5266 20.1813L23.4375 18.9079L25.3477 20.1813C25.4652 20.2602 25.602 20.3055 25.7434 20.3124C25.8848 20.3193 26.0254 20.2875 26.15 20.2204C26.2747 20.1536 26.3789 20.0543 26.4516 19.9329C26.5242 19.8115 26.5626 19.6727 26.5625 19.5313V12.5001H38.2812V42.1876Z" />
                                    </svg>
                                </div>
                                <h2>
                                    <a href="services.php">Last-Mile Delivery</a>
                                </h2>
                                <p>Quick and urgent delivery within the same day, pre-arranged pickup and drop-off at
                                    specific times.</p>
                            </div>
                ...
                <div class="swiper-wrapper">
                        ...
                        <div class="row g-0">
                            <div class="col-xl-6">
                                <div class="feature-img">
                                    <img src="themes/theme3/assets/img/home4/feature-section-feature-img.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="feature-wrapper">
                                    <div class="feature">
                                        <h2>Small & Large Parcel Delivery at a time.</h2>
                                        <ul class="feature-list">
                                            <li class="single-feature">
                                                <img src="themes/theme3/assets/img/home4/icon/feature-list-icon.svg" alt="">
                                                Fast and Secure
                                            </li>
                                            <li class="single-feature">
                                                <img src="themes/theme3/assets/img/home4/icon/feature-list-icon.svg" alt="">
                                    ...
                                    <img class="vector" src="themes/theme3/assets/img/home4/vector/home4-feature-section-vector.png"
                                        alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="row g-0">
                            <div class="col-xl-6 ">
                                <div class="feature-img">
                                    <img src="themes/theme3/assets/img/home4/feature-section-feature-img2.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="feature-wrapper">
                                    <div class="feature">
                                        <h2>Smart Logistics for Modern Businesses.</h2>
                                        <ul class="feature-list">
                                            <li class="single-feature">
                                                <img src="themes/theme3/assets/img/home4/icon/feature-list-icon.svg" alt="">
                                                Real-Time Tracking
                    ...
                    <div class="swiper-slide">
                        <div class="row g-0">
                            <div class="col-xl-6">
                                <div class="feature-img">
                                    <img src="themes/theme3/assets/img/home4/feature-section-feature-img3.jpg" alt="">
                                </div>
                            </div>
                            <div class="col-xl-6">
                                <div class="feature-wrapper">
                                    <div class="feature">
                                        <h2>Seamless International Freight Solutions.</h2>
                                        <ul class="feature-list">
                                            <li class="single-feature">
                                                <img src="themes/theme3/assets/img/home4/icon/feature-list-icon.svg" alt="">
                                                Global Coverage
    ...
    <div class="home2-company-banner-img five mb-120">
        <div class="container">
            <span>We’ve delivered over 1.2 billion items.</span>
                        ...
                        <form action="contact.php" method="post">
                            <div class="row g-4">
                                ...
                                <div class="col-md-12">
                                    <div class="form-inner">
                                        <label>Message</label>
                                        <textarea name="tmessage" required></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        btn.addEventListener('click', function () {
            var zone = parseFloat((document.querySelector('input[name="calcZone"]:checked') || {}).value) || 1;
            var weight = parseFloat(document.getElementById('calcWeight').value) || 0;
            var units = parseInt(document.getElementById('calcUnits').value, 10) || 1;
            var rate = parseFloat(document.getElementById('calcType').value) || 0;
            var base = 15; // base handling fee
            var total = (base + (weight * rate * zone)) * units;
            total = total * 1.015; // VAT (1.5%) as noted below the form
            document.getElementById('calcResultValue').textContent = '$' + total.toFixed(2);
